...
<head>
    ...
    <title>Soko Aerial - Individual Accounts </title>
    <!-- Favicon icon -->
        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll">
                <ul class="metismenu" id="menu">
					...
					<li><a class="ai-icon" href=""{{url('events')}}" aria-expanded="false">
				...
				<div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="{{url('all-transactions')}}">Payments</a></li>
                            <li class="breadcrumb-item active"><a href="{{url('add-department')}}">Make Payments</a></li>
                        </ol>
                    </div>
                </div>
				...
				<div class="row">
					<div class="col-xl-12 col-xxl-12 col-sm-12">
                        <div class="card">
                            ...
                            <h2 style="margin-left: 20px;">Fee Deposit: 
                                <?php   
                                  if($fee){
                                    $total = 0;
                                    $balance =0;
							...
							<div class="card-body">
                                <form action="{{url('fee-add')}}" method="POST">
                                    @csrf
									<div class="row">
