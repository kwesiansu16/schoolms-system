...
<head>
    ...
    <title>Soko Aerial - Add Department </title>
    <!-- Favicon icon -->
				...
				<div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="{{url('all-departments')}}">Departments</a></li>
                            <li class="breadcrumb-item active"><a href="{{url('add-department')}}">Add Departments</a></li>
                        </ol>
                    </div>
                </div>
							...
							<div class="card-body">
                                <form action="{{url('departments-store')}}" method="POST">
									...
									<div class="col-lg-12 col-md-12 col-sm-12">
											<div class="form-group">
												<label class="form-label">Depatment Details</label>
												<textarea class="form-control" name="dep_details" rows="5"></textarea>
											</div>
										</div>
