...
<head>
    ...
    <title>Soko Aerial - All students</title>
    <!-- Favicon icon -->
...
<body>
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                ...
                <img class="brand-title" src="{{asset('style/images/log.png')}}" alt="logo">
            </a>
				...
				<div class="row">
					<div class="col-lg-12">
						<ul class="nav nav-pills mb-3">
							<li class="nav-item"><a href="#list-view" data-toggle="tab" class="nav-link btn-dark mr-1 show active">List of Students</a></li>
							...
							<div id="list-view" class="tab-pane fade active show col-lg-12">
								<div class="card">
									<div class="card-header">
										...
										<a href="{{url('add-student')}}" class="btn btn-dark">+ Add new Student</a>
									</div>
									<div class="card-body">
										<div class="table-responsive">
                                            @if(session('message'))
                                            
                                            <p style="color:white; font-weight:bold;" class="alert alert-success alert-dismissible fade show">{{ session('message') }}
                                            ...
                                            <p  style="color:white; font-weight:bold;" class="alert alert-danger alert-dismissible fade show">{{ session('message1') }}
                                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            </p>
											...
											<table id="example3" class="display" style="min-width: 845px">
												...
												<tbody>
                                                    @foreach($sokostudents as $sokostudent)
													<tr>
											       <td><span>{{$sokostudent->created_at->diffForHumans()}}</span></td>

														<td><strong>{{$sokostudent->id}}</strong></td>
													
														<td>{{$sokostudent->last_name}}</td>
														<td><a href="javascript:void(0);"><strong>{{$sokostudent->first_name}}</strong></a></td>
														<td><a href="javascript:void(0);"><strong>{{$sokostudent->email}}</strong></a></td>
														<td>{{$sokostudent->phone_number}}</td>
                                                        <td>{{$sokostudent->registration_date}}</td>
														<td>{{$sokostudent->completion_date}}</td>
                                                        <td>{{$sokostudent->address}}</td>
                                                      
                                                        <td>{{$sokostudent->programname}}</td>
														<td>
															<a href="{{route('single.student', ['id' => $sokostudent->id])}}" class="btn btn-sm btn-dark"><i class="fa fa-eye"></i></a>	
														</td>
														
														<td><img  width="70px" height="70px" src="{{asset('uploads/students/'.$sokostudent->image)}}" alt="image"></td>  
                                               
                                               
														<td><a href="{{route('sokostudent.fee', ['id' => $sokostudent->id])}}" class="btn btn-sm btn-success"><i class="fa fa-money"></i></a>	
														</td>
														<td>
															<a href="{{route('sokostudent.edit', ['id' => $sokostudent->id])}}" class="btn btn-sm btn-dark"><i class="la la-pencil"></i></a>
															<a href="{{route('sokostudent.delete', ['id' => $sokostudent->id])}}" class="btn btn-sm btn-danger"><i class="la la-trash-o"></i></a>
														</td>												
													</tr>
                                                    @endforeach											
												</tbody>
    ...
    ***********************************-->
	...
	<!-- Datatable -->
    <script src="{{asset('style/vendor/datatables/js/jquery.dataTables.min.js')}}"></script>
