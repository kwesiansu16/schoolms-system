				...
				<div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="{{url('all-departments')}}"><a href="javascript:void(0);">All courses</a></li>
                        </ol>
                    </div>
                </div>
				...
				<div class="row">
					<div class="col-lg-12">
						<ul class="nav nav-pills mb-3">
							<li class="nav-item"><a href="#list-view" data-toggle="tab" class="nav-link btn-dark mr-1 show active">List of Courses</a></li>
							...
							<div id="list-view" class="tab-pane fade active show col-lg-12">
								<div class="card">
									<div class="card-header">
										...
										<a href="{{url('add-program')}}" class="btn btn-dark">+ Add new Courses</a>
									</div>
									<div class="card-body">
											...
											<table id="example3" class="display" style="min-width: 845px">
												...
												<tbody>
													...
													<tr>
														...
														<td><a href=""><strong>{{$program->programname}}</strong></a></td>
                                                        <td><a href=""><strong>{{$program->dep_name}}</strong></a></td>
