...
<head>
    ...
    <title>Soko Aerial - All Instructors</title>
    <!-- Favicon icon -->
				...
				<div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="{{url('all-instructors')}}"><a href="javascript:void(0);">All Instructors</a></li>
                        </ol>
                    </div>
                </div>
				...
				<div class="row">
					<div class="col-lg-12">
						<ul class="nav nav-pills mb-3">
							<li class="nav-item"><a href="#list-view" data-toggle="tab" class="nav-link btn-dark mr-1 show active">List of Instructors</a></li>
							...
							<div id="list-view" class="tab-pane fade active show col-lg-12">
								<div class="card">
									<div class="card-header">
										...
										<a href="{{url('add-instructor')}}" class="btn btn-dark">+ Add new Instructor</a>
									</div>
									<div class="card-body">
										<div class="table-responsive">
											...
											<table id="example3" class="display" style="min-width: 845px">
												...
												<tbody>
                                                    @foreach($sokoinstructors as $sokoinstructor)
													<tr>
                                                        <td><span>{{$sokoinstructor->created_at->diffForHumans()}}</span></td>
														<td><strong>{{$sokoinstructor->id}}</strong></td>
													
														<td>{{$sokoinstructor->last_name}}</td>
														<td><a href="javascript:void(0);"><strong>{{$sokoinstructor->first_name}}</strong></a></td>
														<td><a href="javascript:void(0);"><strong>{{$sokoinstructor->email}}</strong></a></td>
														<td>{{$sokoinstructor->phone_number}}</td>
                                                        <td>{{$sokoinstructor->joining_date}}</td>
                                                        <td>{{$sokoinstructor->designation}}</td>
                                                        <td>{{$sokoinstructor->address}}</td>
														<td>
															<a href="{{route('sokoinstructor.edit', ['id' => $sokoinstructor->id])}}" class="btn btn-sm btn-dark"><i class="la la-pencil"></i></a>
															<a href="{{route('sokoinstructor.delete', ['id' => $sokoinstructor->id])}}" class="btn btn-sm btn-danger"><i class="la la-trash-o"></i></a>
														</td>												
													</tr>
                                                    @endforeach											
												</tbody>
