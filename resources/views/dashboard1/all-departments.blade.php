...
<head>
    ...
    <title>Soko Aerial - All Departments</title>
    <!-- Favicon icon -->
            ...
            <div class="container-fluid">
				...
				<div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href=""{{url('all-departments')}}">Department</a></li>
                            <li class="breadcrumb-item active"><a href="{{url('all-departments')}}">All departments</a></li>
                        </ol>
                    </div>
                </div>
				...
				<div class="row">
					<div class="col-lg-12">
						<ul class="nav nav-pills mb-3">
							<li class="nav-item"><a href="#list-view" data-toggle="tab" class="nav-link btn-dark mr-1 show active">List of Departments</a></li>
							...
							<div id="list-view" class="tab-pane fade active show col-lg-12">
								<div class="card">
									<div class="card-header">
										...
										<a href="{{url('add-department')}}" class="btn btn-dark">+ Add new Departments</a>
									</div>
									<div class="card-body">
										<div class="table-responsive">
											...
											<table id="example3" class="display" style="min-width: 845px">
												...
												<tbody>
													...
													<tr>
                                                        <td><span>{{$department->created_at->diffForHumans()}}</span></td>
														<td><strong>{{$department->id}}</strong></td>
													
														
														<td><a href=""><strong>{{$department->dep_name}}</strong></a></td>
														<td><a href=""><strong>{{$department->dep_details}}</strong></a></td>
														
														<td>
															<a href="{{route('department.edit', ['id' => $department->id])}}" class="btn btn-sm btn-dark"><i class="la la-pencil"></i></a>
															<a href="{{route('department.delete', ['id' => $department->id])}}" class="btn btn-sm btn-danger"><i class="la la-trash-o"></i></a>
														</td>												
													</tr>
                                                    @endforeach											
												</tbody>
