...
<head>
    ...
    <title>Soko Aerial - Add Course </title>
    <!-- Favicon icon -->
            ...
            <div class="dlabnav-scroll">
                <ul class="metismenu" id="menu">
					...
					<li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{url('all-instructors')}}">All Instructors</a></li>
				...
				<div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4 style="color:black;">Update Course</h4>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{url('home')}}">Home</a></li>
                            <li class="breadcrumb-item active"><a href="{{url('all-programs')}}">Courses</a></li>
                            <li class="breadcrumb-item active"><a href="{{url('add-program')}}">Add Course</a></li>
                        </ol>
                    </div>
                </div>
				...
				<div class="row">
					<div class="col-xl-12 col-xxl-12 col-sm-12">
                        <div class="card">
							...
							<div class="card-body">
                                <form action="{{ route('course.update', $programs->id) }}" method="POST">
                                    @csrf
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control"  name="departmentid">
                                                ...
                                                <option  value="{{$departments->id}}">{{$department->dep_name}}</option>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{$programs->programname}}" name="programname" placeholder="Course Name" class="form-control">
                                        </div>
                                    </div>
