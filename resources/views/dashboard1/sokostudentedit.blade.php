...
<head>
    ...
    <title>Soko Aerial - Update student details</title>
    <!-- Favicon icon -->
				...
				<div class="row">
					<div class="col-xl-12 col-xxl-12 col-sm-12">
                        <div class="card">
							...
							<div class="card-body">
                                <form action="{{ route('sokostudent.update', $sokostudents->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
									<div class="row">
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">First Name</label>
												<input type="text" value="{{$sokostudents->first_name}}" name="first_name" class="form-control">
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">Last Name</label>
												<input type="text" value="{{$sokostudents->last_name}}" name="last_name" class="form-control">
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">Email</label>
												<input type="text" value="{{$sokostudents->email}}" name="email" class="form-control">
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">Registration Date</label>
												<input name="registration_date" value="{{$sokostudents->registration_date}}" class="datepicker-default form-control" id="datepicker">
											</div>
										</div>
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												...
												<input type="text" value="{{$sokostudents->phone_number}}" name="phone_number" class="form-control">
											</div>
										</div>
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												...
												<input name="completion_date" value="{{$sokostudents->completion_date}}" class="datepicker-default form-control" id="datepicker1">
											</div>
										</div>
                                        <div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">Residential Address</label>
												<input name="address" value="{{$sokostudents->address}}" class="form-control" id="datepicker1">
											</div>
										</div>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">
											<div class="form-group fallback w-100">
                                                ...
                                                <img  width="70px" height="70px" src="{{asset('uploads/students/'.$sokostudents->image)}}" alt="image"></td>  
											</div>
										</div>
		
									
										<div class="col-lg-12 col-md-12 col-sm-12">
											<button type="submit" name="submit" class="btn btn-dark" style="">Update</button>
