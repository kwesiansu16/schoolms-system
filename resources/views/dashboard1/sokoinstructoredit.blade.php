...
<head>
    ...
    <title>Soko Aerial - Update instructor details</title>
    <!-- Favicon icon -->
				...
				<div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4 style="color:black;">Update Instructor ({{$sokoinstructors->first_name}}) Details</h4>
                        </div>
                    </div>
				...
				<div class="row">
					<div class="col-xl-12 col-xxl-12 col-sm-12">
                        <div class="card">
							...
							<div class="card-body">
                                <form action="{{ route('sokoinstructor.update', $sokoinstructors->id) }}" method="POST">
                                    @csrf
									<div class="row">
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">First Name</label>
												<input type="text" value="{{$sokoinstructors->first_name}}" name="first_name" class="form-control">
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">Last Name</label>
												<input type="text" value="{{$sokoinstructors->last_name}}" name="last_name" class="form-control">
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">Email</label>
												<input type="text" value="{{$sokoinstructors->email}}" name="email" class="form-control">
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">Joining Date</label>
												<input  value="{{$sokoinstructors->joining_date}}" name="joining_date" class="datepicker-default form-control" id="datepicker">
											</div>
										</div>
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												...
												<input type="text" value="{{$sokoinstructors->phone_number}}" name="phone_number" class="form-control">
											</div>
										</div>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												...
												<input type="text" value="{{$sokoinstructors->designation}}" name="designation" class="form-control">
											</div>
										</div>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												...
												<input name="address" value="{{$sokoinstructors->address}}" class="form-control" id="datepicker1">
											</div>
										</div>
